...
export default function (ctx, inject) {
  ...
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/users/sign_in","method":"post","propertyName":"token"},"logout":{"url":"/users/sign_out","method":"delete"},"user":{"url":"/users/current","method":"get","propertyName":"user"}},"_name":"local"}))
